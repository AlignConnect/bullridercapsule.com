...
function MenProblem() {
    return (<div>
        <div className='purush_background'>
            <div className='w-full max-w-7xl mx-auto'>
                <div className='grid md:grid-cols-2 grid-rows-1 gap-2 items-center'>
                    ...
                    <div className='py-3'>
                        <Image className='mx-auto min-h-[180px]' src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4ac98633-88a0-46c2-42cd-3dc93a87b100/public"} width={450} height={500} alt='sed_text_image' loading='lazy' />
        ...
        <div className='w-full max-w-7xl mx-auto'>
            <div className='py-4'>
                <Image className='mx-auto px-2 min-h-[100px]' src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0639944f-3286-41b4-91f5-92286a9a0a00/public"} width={200} height={500} alt='bullrider_required_image' loading='lazy' />
            </div>
