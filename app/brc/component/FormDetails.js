...
const AmaFlipDialog = lazy(() => import('@/app/commonUse/AmaFlipDialog/AmaFlipDialog'));
...
const FormDetails = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Bullridercapsule.com/brc")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_BRC ?? "bullridercapsule.com/brc")
    ...
    return (
        <div className="">
            ...
            <div className="my-6 bg-white" id="form">
