...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Bullridercapsule.com/BRJ")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_BRJ ?? "bullridercapsule.com/brj")
                    ...
                    <div className="max-w-2xl mx-auto  mt-4  p-3 border border-[#f2c700] rounded-md ">
                        <div className="py-4">
                            <div className="text-center">
                                <h1 className=" text-xl md:text-4xl font-bold  mb-5">प्रोडक्ट के बारे में एक्सपर्ट्स से अधिक जानकारी के लिए निचे दिया फॉर्म भरें</h1>
                            </div>
