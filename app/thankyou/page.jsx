                ...
                <div className="bg-[white] p-2 rounded-xl w-[95%] md:w-[500px] ">
                    ...
                    <section className="text-end p-1" style={{ fontFamily: "sans-serif" }}>
                        <button className="text-xl" onClick={() => {
                            closePopup();
                            window.location.href = "https://flipkart.la/4avaQWk";
                            ...
                            <div className="grid justify-center my-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="AmaFlipPop" style={{ paddingTop: '-0.5rem' }}>
                                        <a href={"https://flipkart.la/3xasVL7"} style={{ textDecoration: 'none' }}><img src="/common_images/flipkart.png" className='OrderNowPopAmaFlip' alt="pic" style={{ width: '75%' }} /></a>
                                    </div>
