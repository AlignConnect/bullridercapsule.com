...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Bullridercapsule.com/FBR")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_FBR ?? "bullridercapsule.com/fbr")
    ...
    return (
        <div className="">
            ...
            <div className="my-4 py-2 bg-white" id="form">
                <div className={`pb-4 text-black px-4 `} id='formcallhide'>
                    <div className="max-w-2xl mx-auto  mt-4 bg-white p-3 border border-black rounded-md ">
                        <div className="py-4">
                            <div className="text-center">
                                <h1 className="fontNoto text-xl md:text-3xl font-bold  mb-5">प्रोडक्ट के बारे में एक्सपर्ट्स से अधिक<br /> जानकारी के लिए निचे दिया फॉर्म भरें</h1>
                            </div>
                            <form className="space-y-3">
                                ...
                                <div className="flex justify-center items-center pt-4 ">
                                    <button onClick={handleFormSubmit} type="button" className="bg-zinc-900 text-xl font-bold px-3 pb-2 pt-3 md:w-72 w-full rounded-md hover:bg-zinc-950 transition-colors text-white">
                                        ORDER NOW
                                    </button>
                                </div>
                            </form>
