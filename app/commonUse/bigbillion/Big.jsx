...
const Big = () => {
  return (
    <div className='grid sm:grid-cols-2 max-w-4xl mx-auto gap-2 py-5'>

      <a href="https://bit.ly/47FR8qM" className=" pop_imagehfv_big">
      ...
      <a href=" https://amzn.to/3TI4sVR" className=" pop_imagehfv_big">
