...
function BrgForm() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append("post", "Bullridercapsule.com/BRPILLOW")
      formdata.append("ip", check ? check : "")
      formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
      formdata.append("blog_url", process.env.NEXT_APP_URL_BRPILLOW ?? "bullridercapsule.com/brpillow")
  ...
  return (
    <div className='bg-black  py-5' id='form'>
      ...
      <div className='w-full max-w-7xl mx-auto'>
        <div className='py-3 px-3 '>
          ...
          <div>
            ...
            <form className="space-y-4 max-w-xl mx-auto bg-white p-4 rounded-xl">
