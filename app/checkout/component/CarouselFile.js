...
const CarouselFile = () => {
    ...
    useMemo(() => {
        FetchAllProductData(process.env.NEXT_APP_API_URL, process.env.NEXT_APP_API_KEY_BRJ, process.env.NEXT_APP_URL_BRJ);
    }, [])
    ...
    return (
        <div className='py-4 px-2'>
            ...
            <Carousel autoPlay interval={4000} infiniteLoop showThumbs={false} showStatus={false} showArrows={false} selectedItem={handleActive}>
                ...
                <div>
                    <Image src={"/checkout_images/pro_check_2.webp"} width={1000} height={1000} alt='no' />
                </div>
                <div>
