...
const page = () => {
    ...
    useEffect(() => {
        ...
        GetCallSetting(process.env.NEXT_APP_API_KEY_BRU);
        FetchWebCheckout(process.env.NEXT_APP_API_KEY_BRU, process.env.NEXT_APP_URL_BRU)

        localStorage.setItem("PATH_KEY", "/bru");
