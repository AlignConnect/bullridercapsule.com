...
function Form() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Bullridercapsule.com/BRU")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_BRK ?? "bullridercapsule.com/bru")
    ...
    return (
        <div className='bg-black rounded-xl' id='form'>
            ...
            <div className='w-full max-w-7xl mx-auto'>
                <div className='py-3 px-3 '>
                    ...
                    <div className=''>
                        ...
                        <form className="space-y-3 max-w-xl mx-auto bg-white p-3 rounded-xl">

                            <div className={`${poppins.className} text-center  text-2xl font-semibold `}>
                                Contact Us
                            </div>

                            <hr className="w-48 h-px mx-auto my-1 bg-gray-300 border-0 rounded bg-black"></hr>
                            ...
                            {CustomerDataValue?.map((data, key) => {
                                return <div key={key}>
                                    ...
                                    <div className="relative">
                                        <label htmlFor="text" className={`${noto.className} block mb-1 text-xl font-medium text-gray-900 dark:text-white`} >{data.label}</label>
