...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Bullridercapsule.com/BRK")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_BRK ?? "bullridercapsule.com/brk")
    ...
    return (
        <section className={noto.className}>
            <div className="my-4 bg-slate-900" id="form">
                ...
                <h1 className="text-2xl text-center bg-[#d59c52] text-black font-bold px-2 pt-3">प्रोडक्ट के बारे में एक्सपर्ट्स से अधिक जानकारी के लिए निचे दिया फॉर्म भरें</h1>

                <div className={`pb-4 text-black ${poppin.className}`} id='formcallhide'>
                    <div className="max-w-2xl mx-4  mt-4 bg-slate-50 p-3 border border-[#d6c1a5] rounded-md ">
                        <div className="py-4">
