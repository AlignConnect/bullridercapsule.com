...
const page = () => {
    ...
    useEffect(() => {
        ...
        GetCallSetting(process.env.NEXT_APP_API_KEY_BRG);
        FetchWebCheckout(process.env.NEXT_APP_API_KEY_BRG, process.env.NEXT_APP_URL_BRG)

        localStorage.setItem("PATH_KEY", "/brg");
